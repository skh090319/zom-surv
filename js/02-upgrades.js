...
const upgrades = [
  ...
  {id:"echoAfterimage",category:"support",name:"잔향 악보",desc:"기억 재현 피해가 단계마다 10% 증가하고 재현 대기시간이 감소합니다",transcendName:"초월: 영원한 후렴",transcendDesc:"기억을 재현해도 저장된 기억이 사라지지 않습니다",requires(){return selectedCharacter==="echo";},apply(){upgradeCount.echoAfterimage++;if(upgradeCount.echoAfterimage<4)player.echoAfterimageLevel++;else transcended.echoAfterimage=true;}},
  {id:"echoPitch",category:"support",name:"절대 음감",desc:"모든 기억 공격 피해가 단계마다 12% 증가합니다",transcendName:"초월: 완전 공명",transcendDesc:"교향곡이 적 최대 체력의 18% 추가 피해를 줍니다",requires(){return selectedCharacter==="echo";},apply(){upgradeCount.echoPitch++;if(upgradeCount.echoPitch<4)player.echoPitchLevel++;else transcended.echoPitch=true;}},
  {id:"echoArchive",category:"support",name:"공명 기록고",desc:"기억 공격의 범위가 단계마다 증가합니다",transcendName:"초월: 아카식 교향곡",transcendDesc:"모든 기억과 교향곡의 범위가 25% 증가합니다",requires(){return selectedCharacter==="echo";},apply(){upgradeCount.echoArchive++;if(upgradeCount.echoArchive<4)player.echoArchiveLevel++;else transcended.echoArchive=true;}},
