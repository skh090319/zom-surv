...
function activateTerraR(){
  ...
  terraStructures.push(field);terraEffects.push({type:"continent",x:field.x,y:field.y,angle,length,width,life:72,maxLife:72});player.terraRCooldown=TERRA_R_COOLDOWN;
}
