...
const characterSkillGuide = {
  ...
  mare:{name:"마레",color:"#45dff0",passive:"물 공격을 반복 적중시키면 침수가 중첩됩니다. 침수된 적은 수압 공격에 더 큰 피해를 받습니다.",skills:[["기본 공격 · 해류","전방으로 넓은 물살을 흘려 적을 옆으로 밀고 침수를 남깁니다."],["Q · 밀물","거대한 파도가 전장을 쓸며 적을 밀어내고 침수를 중첩합니다."],["E · 소용돌이 핵","물의 핵을 설치해 적을 끌어당깁니다. 다시 사용하면 핵이 폭발합니다."],["X · 수압","침수된 모든 적을 압축해 중첩에 비례한 피해를 줍니다."],["R · 심해 개방","10레벨부터 거대한 고래 해류를 불러 적을 반복 공격하고 둔화합니다."]]},
};
