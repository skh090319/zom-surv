...
function drawMobileHomeScreen(){
  ...
  ctx.textAlign="left";ctx.fillStyle="#ff536d";ctx.font="900 10px Arial";ctx.fillText("NIGHT PROTOCOL / 03",pad,20);drawBloodiedLobbyTitle("ZOMBIE SURVIVAL",pad,38,24,"#f4f5ff");
