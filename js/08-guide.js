...
function drawGuideAugmentCard(u,x,y,w,h) {
  ...
  ctx.fillStyle="#fff5e7";ctx.font=`bold ${w<190?15:18}px Arial`;ctx.fillText(u.name,x+w/2,y+135);ctx.fillStyle="#c8d1e1";ctx.font=`${w<190?11:12}px Arial`;wrapTextClamped(typeof u.getDesc==="function"?u.getDesc():u.desc,x+w/2,y+158,w-24,16,3);
