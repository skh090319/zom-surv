...
function drawPlayer() {
  ...
  const activeSprite = selectedCharacter === "echo"
    ? echoSprite
  ...
  const activeLoaded = selectedCharacter === "echo"
    ? echoSpriteLoaded
    : selectedCharacter === "vargas"
    ? vargasSpriteLoaded
    : selectedCharacter === "terra"
  ...
  if (activeLoaded) {
    const size = selectedCharacter === "vargas" ? (player.vargasUltimateTime>0?142:122) : ((selectedCharacter === "luminous" || selectedCharacter === "ren" || selectedCharacter === "nightLord" || selectedCharacter === "zero" || selectedCharacter === "paladin" || selectedCharacter === "arc" || selectedCharacter === "terra" || selectedCharacter === "void" || selectedCharacter === "echo") ? 112 : ((selectedCharacter === "suncall" || selectedCharacter === "yupiter") ? 104 : 96));
  ...
  if (gunSpriteLoaded && selectedCharacter !== "luminous" && selectedCharacter !== "yupiter" && selectedCharacter !== "ren" && selectedCharacter !== "nightLord" && selectedCharacter !== "zero" && selectedCharacter !== "paladin" && selectedCharacter !== "arc" && selectedCharacter !== "terra" && selectedCharacter !== "void" && selectedCharacter !== "carmilla" && selectedCharacter !== "vargas" && selectedCharacter !== "echo") {
    const gunW = 68;
    const gunH = 30;
