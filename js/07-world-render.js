...
function drawPlayer() {
  ...
  const activeSprite = selectedCharacter === "vargas"
    ? vargasSprite
  ...
  const activeLoaded = selectedCharacter === "vargas"
    ? vargasSpriteLoaded
    : selectedCharacter === "terra"
    ? terraSpriteLoaded
    : selectedCharacter === "carmilla"
  ...
  if (activeLoaded) {
    const size = selectedCharacter === "vargas" ? (player.vargasUltimateTime>0?142:122) : ((selectedCharacter === "luminous" || selectedCharacter === "ren" || selectedCharacter === "nightLord" || selectedCharacter === "zero" || selectedCharacter === "paladin" || selectedCharacter === "arc" || selectedCharacter === "terra" || selectedCharacter === "void") ? 112 : ((selectedCharacter === "suncall" || selectedCharacter === "yupiter") ? 104 : 96));
  ...
  if (gunSpriteLoaded && selectedCharacter !== "luminous" && selectedCharacter !== "yupiter" && selectedCharacter !== "ren" && selectedCharacter !== "nightLord" && selectedCharacter !== "zero" && selectedCharacter !== "paladin" && selectedCharacter !== "arc" && selectedCharacter !== "terra" && selectedCharacter !== "void" && selectedCharacter !== "carmilla" && selectedCharacter !== "vargas") {
    const gunW = 68;
    const gunH = 30;
